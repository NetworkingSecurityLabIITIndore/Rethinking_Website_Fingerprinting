...
category_model_path = 'trained models/knn/category.pkl'  # Path to your category model
...
for category in categories:
    website_model_path = f'trained models/knn/{category}.pkl'  # Path for each category's website model
...
results_df.to_excel('prediction_results_knn.xlsx', index=False)
